...
public class HelloController implements Initializable{
    ...
    protected void onAdminButtonClick(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("ViewAdminCoy.fxml"));
    ...
    @FXML
    protected void goGameButton(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("PlayCouponCoy.fxml"));
        stage = (Stage) ((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
